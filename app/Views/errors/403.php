...
<body class="h-full bg-slate-100 text-slate-800 flex items-center justify-center p-6 text-center">
    <div class="max-w-md bg-white border border-slate-200 p-8 rounded-2xl shadow-xl">
        ...
        <h1 class="text-xl font-bold text-slate-900 mb-2">403 - Access Restricted</h1>
        <p class="text-xs text-slate-500 mb-6">Your staff role does not have administrative permission to view this module.</p>
